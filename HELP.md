...
* The original package name 'com.ogreface.panic-button' is invalid and this project uses 'com.ogreface.panicbutton' instead.
...
```
$ docker run --rm -p 8080:8080 panic-button:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/panic-button
```
